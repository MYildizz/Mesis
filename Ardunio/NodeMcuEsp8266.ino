...
// user config: TODO
const char* wifi_ssid = "p0tas";             // SSID
const char* wifi_password = "mertingen8551";         // WIFI
const char* apiKeyIn = "kHVDcPvB1pyqwE5CHcsiIjECq437hNPL";      // API KEY IN
...
void loop() {
  ...
  if(buton_durumu == 0){
    Serial.println("Kapak kapalı!");
    digitalWrite(Led,LOW);
  
    
  }
  else{
    Serial.println("Kapak açık.");
